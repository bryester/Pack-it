                                 ...
                                 responseHandler:(NXOAuth2ConnectionResponseHandler)responseHandler;
{
    ...
    [request setValue:[self.parameters objectForKey:@"Content-Type"] forHTTPHeaderField:@"Content-Type"];
    [request setValue:[self.parameters objectForKey:@"API-VERSION"] forHTTPHeaderField:@"API-VERSION"];
    [request setValue:[self.parameters objectForKey:@"Authorization"] forHTTPHeaderField:@"Authorization"];
